...
| `security_activity_layout` | `sidebar` \| `section` | `section` | v1.4.0 | Aktivitäts-Verlauf als normale Section (Standard) oder rechts angepinnt (Seitenleiste) |
| `security_activity_position` | `start` \| `end` | `start` | v1.4.0 | Aktivitäts-Section an erster (Standard) oder letzter Stelle |
