...
| `security_activity_layout` | `sidebar` \| `section` | `sidebar` | v1.4.0 | Aktivitäts-Verlauf rechts angepinnt (Seitenleiste) oder als normale Section am Ende |
