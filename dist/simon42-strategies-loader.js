...
const features = ['Better Thermostat', 'Public Transport (HVV, ha-departures, db_info)', 'Reactive Group Cards', 'Bilingual Support (DE/EN)', 'Horizon Card', 'Entity Name Transformation'];
