...
export const de = {
  ...
  searchCardDomainsPlaceholder: "z.B. light, switch, cover",
  searchCardIncludedDomainsDescription: "Nur Entities aus diesen Domains in der Suche anzeigen (kommagetrennt, z.B. 'light, switch, cover'). Leer lassen für alle Domains.",
  searchCardExcludedDomainsDescription: "Entities aus diesen Domains von der Suche ausschließen (kommagetrennt, z.B. 'sensor, binary_sensor'). Leer lassen für keine Ausschlüsse.",
  clockCard: "Uhr-Karte",
