...
export const de = {
  ...
  favorites: "Favoriten",
  areas: "Bereiche",
  arrangeAreas: "Bereiche anordnen",
  ...
  alarmControlPanel: "Alarmzentrale",
  ...
  favoritesList: "Favoriten Liste",
  noRoomPinsAdded: "Keine Raum-Pins hinzugefügt",
  roomPinsList: "Raum-Pins Liste",
  noRoom: "Kein Raum",
  searchCard: "Such-Karte",
  showSearchCard: "Such-Karte in Übersicht anzeigen",
  searchCardPlaceholder: "Tippe zum Suchen...",
  searchCardIncludedDomains: "Einbezogene Domains",
  searchCardExcludedDomains: "Ausgeschlossene Domains",
  selectDomain: "Domain auswählen...",
  noDomainsAdded: "Keine Domains hinzugefügt",
  searchCardIncludedDomainsDescription: "Nur Entities aus diesen Domains in der Suche anzeigen. Leer lassen für alle Domains.",
  searchCardExcludedDomainsDescription: "Entities aus diesen Domains von der Suche ausschließen. Leer lassen für keine Ausschlüsse.",
  clockCard: "Uhr-Karte",
  ...
  useClockWeatherCard: "Clock Weather Card verwenden",
  clockWeatherCardDescription: "Ersetzt die Standard-Wetter-Karte durch die Clock Weather Card, die Uhrzeit, Datum und Wettervorhersage kombiniert.",
  clockWeatherCardMissingDeps: "Benötigt clock-weather-card. Bitte installiere die Card über HACS, um diese Funktion zu nutzen.",
  clockWeatherCardLink: "Clock Weather Card:",
  ...
  showSummaries: "Zusammenfassungen anzeigen",
  ...
  errorLoadingEntities: "Fehler beim Laden der Entitäten",
  ...
  alarmEntityDescription: "Wähle eine Alarmzentrale-Entität aus, um sie neben der Uhr anzuzeigen. \"Keine\" auswählen, um nur die Uhr in voller Breite anzuzeigen.",
  useAlarmoCard: "Alarmo-Karte verwenden",
  useAlarmoCardDescription: "Verwendet die Alarmo-Karte statt der Standard-Tile-Karte für die ausgewählte Alarm-Entität.",
  alarmoCardMissingDeps: "Die Alarmo-Karte ist nicht installiert.",
  alarmoCardLink: "Alarmo-Karte:",
  scheduler: "Scheduler",
  showSchedulerCard: "Scheduler-Karte anzeigen",
  schedulerCardDescription: "Zeigt eine Scheduler-Karte an, um Zeitpläne zu verwalten.",
  schedulerCardMissingDeps: "Die Scheduler-Karte oder die Scheduler-Integration ist nicht installiert.",
  schedulerCardLink: "Scheduler-Karte:",
  ...
  calendarCardProOptional: "Die Standard-Kalender-Karte ist in Home Assistant integriert. Calendar Card Pro ist optional und bietet erweiterte Funktionen.",
  useCalendarCardPro: "Calendar Card Pro verwenden",
  useCalendarCardProDescription: "Verwendet die Calendar Card Pro statt der Standard-Kalender-Karte. Calendar Card Pro bietet erweiterte Funktionen und bessere Performance.",
  calendarEntitiesDescription: "Wähle Kalender-Entitäten aus, die in der Kalender-Karte angezeigt werden sollen.",
  calendarEntitiesList: "Kalender-Entitäten Liste",
  todo: "Todo",
  showTodoSwipeCard: "Todo Swipe Card anzeigen",
  todoSwipeCardDescription: "Zeigt eine Todo Swipe Card mit ausgewählten Todo-Entitäten an.",
  todoSwipeCardMissingDeps: "Die Todo Swipe Card ist nicht installiert.",
  todoSwipeCardLink: "Todo Swipe Card:",
  todoEntitiesDescription: "Wähle Todo-Entitäten aus, die in der Todo Swipe Card angezeigt werden sollen.",
  todoEntitiesList: "Todo-Entitäten Liste",
  ...
  favoritesDomainFilterDescription: "Filtere die Entitätsliste nach Domain, um die Auswahl zu erleichtern.",
  ...
  roomPinsAreaFilterDescription: "Filtere die Entitätsliste nach Raum, um die Auswahl zu erleichtern.",
  ...
  betterThermostatIntegrationLink: "Better Thermostat Integration:",
  betterThermostatCardLink: "Better Thermostat UI Card:",
  ...
  summariesDescription: "Zeigt die Zusammenfassungskarten in der Übersicht an. Du kannst einzelne Zusammenfassungen über die Unteroptionen aktivieren oder deaktivieren.",
  ...
  entityNamePatterns: "Entity-Namen Regex-Filter",
  ...
  patternList: "Regex-Pattern Liste",
  ...
  translationList: "Übersetzungsliste",
  translationFromPlaceholder: "Von (z.B. 'Bedroom')",
  translationToPlaceholder: "Nach (z.B. 'Schlafzimmer')",
  translationFromLang: "Quellsprache",
  translationToLang: "Zielsprache",
