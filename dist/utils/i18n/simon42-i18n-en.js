...
export const en = {
  ...
  calendarCardProOptional: "The standard calendar card is integrated in Home Assistant. Calendar Card Pro is optional and provides advanced features.",
  ...
  todo: "Todo",
  showTodoSwipeCard: "Show Todo Swipe Card",
  todoSwipeCardDescription: "Shows a Todo Swipe Card with selected todo entities.",
  todoSwipeCardMissingDeps: "The Todo Swipe Card is not installed.",
  todoSwipeCardLink: "Todo Swipe Card:",
  todoEntitiesDescription: "Select todo entities to display in the Todo Swipe Card.",
  todoEntitiesList: "Todo Entities List",
  favoritesDescription: "Select entities to display as favorites under the summaries. The entities will be displayed as tiles.",
  favoritesDomainFilterDescription: "Filter the entity list by domain to make selection easier.",
  ...
  roomPinsAreaFilterDescription: "Filter the entity list by room to make selection easier.",
