...
export const en = {
  ...
  searchCardDomainsPlaceholder: "e.g. light, switch, cover",
  searchCardIncludedDomainsDescription: "Only show entities from these domains in search (comma-separated, e.g. 'light, switch, cover'). Leave empty for all domains.",
  searchCardExcludedDomainsDescription: "Exclude entities from these domains from search (comma-separated, e.g. 'sensor, binary_sensor'). Leave empty for no exclusions.",
