...
const translations = {
  de: {
    ...
    publicTransportDescription: "Zeigt Abfahrtszeiten des öffentlichen Nahverkehrs in der Übersicht an. Verwende die hvv-card für die Anzeige.",
  ...
  en: {
    ...
    publicTransportDescription: "Shows public transport departure times in the overview. Use the hvv-card for display.",
